...
from fed_utils import split_indices_into_batches, get_available_corruptions, get_dataset, create_schedule_iid, create_schedule_niid
...
def main(severity, device):
    ...
    for i in tqdm(range(cfg.MISC.NUM_STEPS)):
        ...
        for client in clients:
            client.model_ema.load_state_dict(deepcopy(ww))
